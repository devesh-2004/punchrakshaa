...
export function generateMetadata(): Metadata {
  return {
    title: "Bulk Orders & Wholesale Pricing | PunchRaksha",
    description:
      "Order PunchRaksha Ayurvedic products in bulk at wholesale prices. Contact our team to get the best rates for large quantity orders.",
      ...
      <div className="w-full bg-[#EEF7F0] pt-[60px] pb-[160px] px-4">
        ...
        <div className="max-w-[760px] mx-auto text-center space-y-5">
          <p className="txt-p-lg">
            Planning to purchase our products in large quantities? We offer
            special wholesale pricing for bulk buyers who want to order our
            products for{" "}
            ...
            , fissure, body pain, and digestive problems.
          </p>
          <p className="txt-p-lg">
            Contact our team to share your quantity requirements and get the
            best wholesale rates for your bulk order.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-[1205px] mx-auto px-4 -mt-[100px] relative z-10">
        <div className="bg-white rounded-[12px] shadow-[0px_-2px_25px_0px_rgba(0,0,0,0.25)] p-8 md:p-[40px] lg:p-[60px] mb-16 flex flex-col md:flex-row gap-8 md:gap-0">
          ...
          <div className="flex-1 md:pr-12">
            <h2 className="txt-h3-lg-alt font-medium text-[#111] mb-8">
            ...
            <div className="space-y-8">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="font-medium text-[#111] txt-p-lg mb-[5px]">
                    +91-7405498441
                  </p>
                  <p className="text-[#555] txt-p">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="font-medium txt-p-lg mb-[5px]">
                    nithastu.care@gmail.com
                  </p>
                  <p className="text-[#555] txt-p">
                    Our team will respond to your email within 24 hours during
                    working days.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-[10px] items-start">
                ...
                <div>
                  ...
                  <p className="text-[#555] txt-p pr-4">
                    E-67, Parishraram Nagar Division-1, Krishnanagar,
                    Ahmedabad-382346
                  </p>
                </div>
              </div>
          ...
          <div className="flex-1 md:pl-[90px] pt-8 md:pt-0">
            <h2 className="txt-h3-lg-alt font-medium text-[#111] mb-6">
              Order Tracking
            </h2>
            ...
            <h2 className="txt-h2 font-medium text-[#111] mb-5">
              Stay Connected Online
            </h2>
            <div className="flex items-center gap-4">
              <Link
                href="https://www.facebook.com/punchraksha/"
                target="_blank"
                aria-label="Facebook"
              ...
              <Link
                href="https://www.instagram.com/punchraksha/"
                target="_blank"
        ...
        <div className="flex justify-center">
          <ButtonBase
            href="/products"
            className="!flex-none !px-10 lg:!w-[400px] !rounded-[15px]"
          >
            BROWSE OUR PRODUCTS
          </ButtonBase>
        </div>
